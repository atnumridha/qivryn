...
describe("shouldIgnore", () => {
  ...
  test("should return true if a folder is ignored by .qivrynignore", async () => {
    addToTestDir([
      ["ignored-folder/file.txt", "content"],
      [".qivrynignore", "ignored-folder/"],
    ]);
  ...
  test("should return true if a .qivrynignore override ignores file", async () => {
    addToTestDir([
      ["override-file.txt", "content"],
      [".gitignore", "override-file.txt"],
      [".qivrynignore", "!override-file.txt"],
    ]);
    const result = await shouldIgnore(
  ...
  test("should return true for deeply nested file ignored by ignore files at multiple levels", async () => {
    addToTestDir([
      ...
      ["level1/level2/.qivrynignore", "level3/"],
    ]);
    const result = await shouldIgnore(
