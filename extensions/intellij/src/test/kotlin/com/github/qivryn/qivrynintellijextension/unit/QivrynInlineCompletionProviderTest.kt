package com.github.qivryn.qivrynintellijextension.unit

import com.github.qivryn.qivrynintellijextension.autocomplete.QivrynInlineCompletionProvider
import com.github.qivryn.qivrynintellijextension.autocomplete.CompletionService
...
class QivrynInlineCompletionProviderTest : BasePlatformTestCase() {
    ...
    override fun setUp() {
        super.setUp()
        InlineCompletionHandler.registerTestHandler(QivrynInlineCompletionProvider(), testRootDisposable)
    }
    ...
    fun `test don't show when settings are disabled`() = myFixture.testInlineCompletion {
        ...
        QivrynExtensionSettings.instance.qivrynState.enableTabAutocomplete = false
