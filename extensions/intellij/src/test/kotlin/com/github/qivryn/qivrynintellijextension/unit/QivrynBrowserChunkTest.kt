...
import com.github.qivryn.qivrynintellijextension.browser.QivrynBrowser
import com.github.qivryn.qivrynintellijextension.browser.QivrynBrowser.Companion.buildChunkScripts
import junit.framework.TestCase
import java.util.Base64

class QivrynBrowserChunkTest : TestCase() {
    ...
    fun `test message splits into expected number of chunks`() {
        ...
        val chunkSize = QivrynBrowser.CHUNK_SIZE
