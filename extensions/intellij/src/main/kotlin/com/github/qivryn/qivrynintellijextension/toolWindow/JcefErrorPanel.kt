...
object JcefErrorPanel {
    ...
    private const val HTML = """
        ...
        <html>
        <h2>
          <center>Qivryn Chat is Unable to Load</center>
        </h2>
        <p>Qivryn Chat requires a JRE that supports the Java Chromium Embedded Framework (JCEF) to render our webview. You can
