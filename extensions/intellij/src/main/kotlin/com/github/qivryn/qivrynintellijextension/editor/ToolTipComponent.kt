import com.github.qivryn.qivrynintellijextension.actions.FocusActionUtil
import com.github.qivryn.qivrynintellijextension.editor.openInlineEdit
...
class ToolTipComponent(editor: Editor, x: Int, y: Int) :
    ...
    init {
        ...
        addToChatButton.addActionListener { e: ActionEvent? ->
            FocusActionUtil.sendHighlightedCodeWithMessageToWebview(editor.project, "focusQivrynInputWithNewSession")
