package com.github.qivryn.qivrynintellijextension

import com.github.qivryn.qivrynintellijextension.editor.RangeInFileWithContents
...
data class IdeSettings(
    ...
    val qivrynTestEnvironment: String
)
...
interface IDE {
    ...
    suspend fun getQivrynDir(): String
...
data class HighlightedCodePayload(
    val rangeInFileWithContents: com.github.qivryn.qivrynintellijextension.RangeInFileWithContents,
