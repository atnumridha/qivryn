...
class QivrynAuthDialog(
    ...
    override fun createCenterPanel(): JComponent {
        ...
        val message =
            if (useOnboarding) "After onboarding you will be shown an authentication token. Please enter it here:" else "Please enter your Qivryn authentication token:"
