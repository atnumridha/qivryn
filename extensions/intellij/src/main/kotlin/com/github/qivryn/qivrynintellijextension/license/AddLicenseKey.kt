package com.github.qivryn.qivrynintellijextension.license
...
class AddLicenseKey : AnAction() {
    ...
    private fun performAddLicenseKey(project: Project?) {
        ...
        if (dialog.exitCode != DialogWrapper.OK_EXIT_CODE)
            return
        val messenger = project.service<QivrynPluginService>().coreMessenger
            ?: return
    ...
    private fun createSuccessAction() =
        getQivrynNotifications().createNotification(
    ...
    private fun getQivrynNotifications() =
        NotificationGroupManager.getInstance().getNotificationGroup("Qivryn")
}