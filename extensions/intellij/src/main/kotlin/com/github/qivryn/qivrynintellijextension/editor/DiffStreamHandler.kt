...
import com.github.qivryn.qivrynintellijextension.StreamDiffLinesPayload
import com.github.qivryn.qivrynintellijextension.GetDiffLinesPayload
...
class DiffStreamHandler(
    ...
    fun streamDiffLinesToEditor(
        ...
        project.service<QivrynPluginService>().coreMessenger?.request(
            "streamDiffLines",
    ...
    private fun initUnfinishedRangeHighlights() {
        ...
        val unfinishedKey = editorUtils.createTextAttributesKey("QIVRYN_DIFF_UNFINISHED_LINE", 0x20888888)
    ...
    private fun updateProgressHighlighters(type: DiffLineType) {
        val editorUtils = EditorUtils(editor)
        val curLineKey = editorUtils.createTextAttributesKey("QIVRYN_DIFF_CURRENT_LINE", 0x40888888)
