package com.github.qivryn.qivrynintellijextension.editor

import com.github.qivryn.qivrynintellijextension.Icons
import com.github.qivryn.qivrynintellijextension.qivryn.GetTheme
import com.github.qivryn.qivrynintellijextension.qivryn.ProfileInfoService
import com.github.qivryn.qivrynintellijextension.services.QivrynExtensionSettings
import com.github.qivryn.qivrynintellijextension.utils.castNestedOrNull
import com.github.qivryn.qivrynintellijextension.utils.getMetaKeyLabel
import com.github.qivryn.qivrynintellijextension.utils.getShiftKeyLabel
...
class CustomPanel(
    ...
    private val subPanelA: JPanel =
        JPanel(MigLayout("insets 0, fillx")).apply {
            val globalScheme = EditorColorsManager.getInstance().globalScheme
            val defaultBackground = globalScheme.defaultBackground
            val qivrynSettingsService = service<QivrynExtensionSettings>()
            val dropdown =
                JComboBox(modelTitles.toTypedArray()).apply {
                    ...
                    selectedIndex =
                        if (itemCount == 0) -1 else qivrynSettingsService.qivrynState.lastSelectedInlineEditModel?.let {
                    ...
                    addActionListener {
                        qivrynSettingsService.qivrynState.lastSelectedInlineEditModel =
