...
import com.github.qivryn.qivrynintellijextension.utils.Debouncer
...
class QivrynPluginSelectionListener(
    ...
    private fun shouldRemoveTooltip(selectedText: String?, editor: Editor): Boolean {
        return selectedText.isNullOrEmpty() ||
                !service<QivrynExtensionSettings>().qivrynState.displayEditorTooltip
    }
