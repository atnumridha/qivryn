...
import com.github.qivryn.qivrynintellijextension.activities.QivrynPluginDisposable
import com.github.qivryn.qivrynintellijextension.activities.showTutorial
...
import com.github.qivryn.qivrynintellijextension.protocol.*
...
import com.github.qivryn.qivrynintellijextension.utils.getMachineUniqueID
...
class IdeProtocolClient(
    ...
    private val ide: IDE = IntelliJIDE(project, qivrynPluginService)
     ...
     *
     * See this thread for details: https://github.com/atnumridha/qivryn/issues/4098#issuecomment-2854865310
     */
                ...
                when (messageType) {
                    ...
                    "jetbrains/onLoad" -> {
                        val jsonData = mutableMapOf(
                            "windowId" to qivrynPluginService.windowId,
                            "workspacePaths" to qivrynPluginService.workspacePaths,
                            "vscMachineId" to getMachineUniqueID(),
                            "vscMediaUrl" to "http://qivryn",
                        )
                        respond(jsonData)
                    }
                    ...
                    "closeSidebar" -> {
                        ApplicationManager.getApplication().invokeLater {
                            ...
                            val toolWindow = toolWindowManager.getToolWindow("Qivryn")
                            toolWindow?.hide()
                        }
                    }
