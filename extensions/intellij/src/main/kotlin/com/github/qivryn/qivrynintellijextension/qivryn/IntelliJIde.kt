...
import com.github.qivryn.qivrynintellijextension.*
...
import com.github.qivryn.qivrynintellijextension.qivryn.file.FileUtils
...
import com.github.qivryn.qivrynintellijextension.utils.*
...
class IntelliJIDE(
    ...
    private val qivrynPluginService: QivrynPluginService,
    ...
    private val ADDITIONAL_SEARCH_IGNORE_FILETYPES = listOf(
        ...
        "*.gcno", "go.sum", "*.gitignore", "*.gitkeep", "*.qivrynignore",
    ...
    private val gitService = GitService(project, qivrynPluginService)
    ...
    override suspend fun getIdeInfo(): IdeInfo {
        ...
        val pluginId = QivrynConstants.PLUGIN_ID
    ...
    suspend fun enableHubQivrynDev(): Boolean {
        return true
    }
    ...
    override suspend fun getIdeSettings(): IdeSettings {
        ...
        return IdeSettings(
            remoteConfigServerUrl = settings.qivrynState.remoteConfigServerUrl,
            remoteConfigSyncPeriod = settings.qivrynState.remoteConfigSyncPeriod,
            userToken = settings.qivrynState.userToken ?: "",
    ...
    override suspend fun getQivrynDir(): String {
        return getQivrynGlobalPath()
    }
    ...
    override suspend fun showDiff(filepath: String, newContents: String, stepIndex: Int) {
        qivrynPluginService.diffManager?.showDiff(filepath, newContents, stepIndex)
    }
    ...
    override suspend fun showToast(type: ToastType, message: String, vararg otherParams: Any): Any {
        return withContext(Dispatchers.Default) {
            ...
            val notification = NotificationGroupManager.getInstance().getNotificationGroup("Qivryn")
                .createNotification(message, notificationType).setIcon(Icons.Qivryn)
    ...
    private fun workspaceDirectories(): Array<String> {
        val dirs = this.qivrynPluginService.workspacePaths
