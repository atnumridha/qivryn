...
import com.github.qivryn.qivrynintellijextension.ApplyState
import com.github.qivryn.qivrynintellijextension.ApplyStateStatus
import com.github.qivryn.qivrynintellijextension.IDE
import com.github.qivryn.qivrynintellijextension.ToastType
import com.github.qivryn.qivrynintellijextension.browser.QivrynBrowserService.Companion.getBrowser
import com.github.qivryn.qivrynintellijextension.editor.DiffStreamHandler
...
import com.github.qivryn.qivrynintellijextension.protocol.ApplyToFileParams
...
class ApplyToFileHandler(
    ...
    companion object {
         ...
         */
        suspend fun apply(
            project: Project, qivrynPluginService: QivrynPluginService, ide: IDE, params: ApplyToFileParams
        ) {
            val editorUtils =
            ...
            val handler = ApplyToFileHandler(
                project, qivrynPluginService, ide, params, editorUtils, diffStreamService
            )
