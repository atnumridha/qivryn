...
// 3. Try asking Qivryn to "make this more readable"
...
// 3. Try asking Qivryn "what sorting algorithm is this?"
...
// 2. Use the "/init" slash command to generate a QIVRYN.md file

  // ——————————————————      Learn more at https://docs.qivryn.ai      ——————————————————— //
