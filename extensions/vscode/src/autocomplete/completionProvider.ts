...
export class QivrynCompletionProvider
  implements vscode.InlineCompletionItemProvider
{
  private async onError(e: unknown) {
    ...
    let message = "Qivryn Autocomplete Error";
    ...
    vscode.window.showErrorMessage(message, "Documentation").then((val) => {
      if (val === "Documentation") {
        vscode.env.openExternal(
          vscode.Uri.parse("https://docs.qivryn.ai/features/tab-autocomplete"),
        );
      }
    });
  }
    ...
    try {
      ...
      const autocompleteCompletionItem = new vscode.InlineCompletionItem(
        ...
        range,
        {
          ...
          command: "qivryn.logAutocompleteOutcome",
      ...
      if (isFim) {
        ...
        // Ghost text acceptance can *technically* be acted upon in the command handler for "qivryn.logNextEditOutcomeAccept".
        ...
        const nextEditCompletionItem = new vscode.InlineCompletionItem(
          ...
          ),
          {
            ...
            command: "qivryn.logNextEditOutcomeAccept",
