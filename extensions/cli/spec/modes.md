...
```bash
qivryn --readonly "Help me analyze this code"  # Starts in plan mode
qivryn --auto "Fix all the linting errors"     # Starts in auto mode
qivryn "Let me implement this feature"         # Starts in normal mode (default)
```
