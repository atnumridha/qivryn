# End-to-End Testing for Qivryn CLI

This document describes the principles, practices, and patterns for writing end-to-end (E2E) tests for the Qivryn CLI.
...
expect(result.exitCode).toBe(0);
expect(result.stdout).toContain("Qivryn CLI");
```
