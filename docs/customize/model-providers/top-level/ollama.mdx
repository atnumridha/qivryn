---
title: "How to Configure Ollama with Qivryn"
slug: ../ollama
sidebarTitle: "Ollama"
---

<Tip>
  **Discover Ollama models [here](https://qivryn.ai/lmstudio)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://qivryn.ai/ollama/qwen3-coder-30b?view=config)**
</Info>
...
Qivryn may set a higher default context length than other Ollama tools, causing this error even when the model works elsewhere. Fix by reducing `contextLength`:
