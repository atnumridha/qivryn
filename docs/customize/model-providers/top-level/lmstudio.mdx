...
<Tip>
  **Discover LM Studio models [here](https://qivryn.ai/lmstudio)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://qivryn.ai/lmstudio/qwen-qwen3-coder-30b?view=config)**
</Info>