---
title: "How to Configure OpenRouter with Qivryn"
sidebarTitle: "OpenRouter"
---

<Tip>
  **Discover OpenRouter models [here](https://qivryn.ai/openrouter)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://qivryn.ai/openrouter/qwen3-coder?view=config)**
</Info>
...
<Info>
  Qivryn automatically uses system message tools for models that don't support
