...
description: "Configure OpenVINO Model Server with Qivryn to use Intel-optimized models for CPU, iGPU, GPU and NPU via the OpenAI-compatible API, supporting code completion with models like CodeLlama and Qwen"
---
