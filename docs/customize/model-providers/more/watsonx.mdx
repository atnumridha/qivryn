---
title: "IBM WatsonX"
description: "How to configure IBM's watsonx models in Qivryn, including authentication methods, deployment options, and support for chat, autocomplete, embeddings, and reranking models"
---
...
To authenticate to watsonx.ai SaaS with Qivryn, you will need to create a project and [set up an API key](https://www.ibm.com/docs/en/mas-cd/continuous-delivery?topic=cli-creating-your-cloud-api-key). Then, in Qivryn:
...
To authenticate to your watsonx.ai Software instance with Qivryn, you can use either `username/password` or `ZenApiKey` method:
