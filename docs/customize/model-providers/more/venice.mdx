---
title: "Venice AI"
description: "Configure Venice AI with Qivryn to access this privacy-focused generative AI platform that supports open-source LLMs without storing private user data"
---
...
Change `~/.qivryn/config.json` to look like the following.
