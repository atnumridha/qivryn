---
title: "Tensorix"
description: "Configure Tensorix with Qivryn to access DeepSeek, Llama, Qwen, GLM, and other models through a single OpenAI-compatible API gateway"
---
...
[View the source](https://github.com/atnumridha/qivryn/blob/main/core/llm/llms/Tensorix.ts)
