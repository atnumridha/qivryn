...
As an example, say you are working on solving a new GitHub Issue. You type '@Issue' and select the one you are working on. Qivryn can now see the issue title and contents. You also know that the issue is related to the files 'readme.md' and 'helloNested.py', so you type '@readme' and '@hello' to find and select them. Now these 3 "Context Items" are displayed inline with the rest of your input.
...
To use it, you need to add a documentation site to your config file. See the [docs](/guides/codebase-documentation-awareness) page for more information.
...
Read more about indexing and retrieval [here](/guides/codebase-documentation-awareness).
...
### Using the Model Context Protocol (MCP) in Qivryn

The [Model Context Protocol](https://modelcontextprotocol.io/introduction) is a standard proposed by Anthropic to unify prompts, context, and tool use. Qivryn supports any MCP server with the MCP context provider. Read their [quickstart](https://modelcontextprotocol.io/quickstart) to learn how to set up a local server and then set up your configuration like this:
...
### How to Request a New Context Provider in Qivryn

Not seeing what you want? Create an issue [here](https://github.com/atnumridha/qivryn/issues/new?assignees=TyDunn&labels=enhancement&projects=&template=feature-request-%F0%9F%92%AA.md&title=) to request a new Context Provider.
