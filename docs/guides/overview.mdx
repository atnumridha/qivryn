---
title: "How to Use Qivryn Guides"
description: "Comprehensive collection of practical guides for Qivryn including model setup, local development with Ollama, offline usage, self-hosting, custom context providers, and advanced customization tutorials"
---

## What Model & Setup Guides Are Available

- [Using Ollama with Qivryn](/guides/ollama-guide) - Local AI development with Ollama
- [How to Self-Host a Model](/guides/how-to-self-host-a-model) - Self-hosting AI models
- [Running Qivryn Without Internet](/guides/running-qivryn-without-internet) - Offline development setup

## CLI & Automation

- [How to Use Qivryn CLI (qivryn)](/guides/cli) - Command-line interface for Qivryn
- [Pull Request Review Bot with GitHub Actions](/guides/github-pr-review-bot) - Set up automated, privacy-first code reviews using Qivryn CLI

## MCP Integration Cookbooks

Step-by-step guides for integrating Model Context Protocol (MCP) servers with Qivryn:

<CardGroup cols={3}>

  <Card title="Qivryn Docs MCP Cookbook" icon="book" href="/guides/qivryn-docs-mcp-cookbook">
    Use the Qivryn Docs MCP to write cookbooks, guides, and documentation with AI-powered workflows
  </Card>

  <Card title="GitHub MCP Cookbook" icon="github" href="/guides/github-mcp-qivryn-cookbook">
    Use GitHub MCP to list, filter, and summarize open issues and merged PRs, and post AI-generated comments
  </Card>

  <Card title="Atlassian MCP Cookbook" icon="atlassian" href="/guides/atlassian-mcp-qivryn-cookbook">
  ...
  <Card title="Sanity CMS Integration Cookbook" icon="database" href="/guides/sanity-mcp-qivryn-cookbook">
  ...
  <Card title="Snyk MCP Cookbook" icon="shield" href="/guides/snyk-mcp-qivryn-cookbook">
  ...
  <Card title="dlt Data Pipelines Cookbook" icon="pipe" href="/guides/dlt-mcp-qivryn-cookbook">
...
Have a guide idea or found an issue? We welcome contributions! Check our [GitHub repository](https://github.com/atnumridha/qivryn) to get involved.
