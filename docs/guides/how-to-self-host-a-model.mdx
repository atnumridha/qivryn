...
description: "Learn how to deploy and self-host open-source language models using HuggingFace TGI, vLLM, SkyPilot, Anyscale Private Endpoints, or Lambda for use with Qivryn"
---

- [HuggingFace TGI](https://github.com/atnumridha/deploy-os-code-llm#tgi)
- [vLLM](https://github.com/atnumridha/deploy-os-code-llm#vllm)
- [SkyPilot](https://github.com/atnumridha/deploy-os-code-llm#skypilot)
- [Anyscale Private Endpoints](https://github.com/atnumridha/deploy-os-code-llm#anyscale-private-endpoints) (OpenAI compatible API)
- [Lambda](https://github.com/atnumridha/deploy-os-code-llm#lambda)

## How to Self-Host an Open-Source Model

For many cases, either Qivryn will have a built-in provider or the API you use will be OpenAI-compatible, in which case you can use the "openai" provider and change the "baseUrl" to point to the server.
