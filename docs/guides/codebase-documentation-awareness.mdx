...
Rules guide agent mode's behavior and understanding. Place markdown files in `.qivryn/rules` in your project to provide context:
...
[DeepWiki MCP](https://qivryn.ai/deepwiki/deepwiki-mcp) lets agent mode explore any public GitHub repository.
...
[Context7 MCP](https://qivryn.ai/upstash/context7-mcp) enables agent mode to search and retrieve information from public documentation:
...
2. **Add rules**: Create `.qivryn/rules` files to provide context about your project structure
...
The new approach provides better integration with Qivryn's Agent mode features and more intelligent context selection.

## Next Steps

- Learn more about [MCP servers](/reference/qivryn-mcp)
