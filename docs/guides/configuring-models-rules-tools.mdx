...
description: "Learn how to work with Qivryn's configuration system. Understand how to use models, rules, and tools, create local configurations, and organize your setup for maximum reusability."
---

## What Are Models, Rules, and Tools?

Qivryn configs are built from three main types of configuration:
...
Qivryn uses a slug in the format of `owner/item-name` to resolve blocks.
...
<Columns cols={2}>
<Card title="Workspace" icon="folder-open">
`.env` file at your project root, or in `<workspace-root>/.qivryn/.env`
</Card>

<Card title="Global" icon="globe">
`.env` file in `~/.qivryn/.env`
</Card>
</Columns>
