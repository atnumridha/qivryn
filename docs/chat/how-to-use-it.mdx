...
description: "Learn how to use Qivryn's Chat mode to solve coding problems without leaving your IDE, including code context sharing, applying generated solutions, and switching between models"
---
...
## How to Use AI Chat in Qivryn for Coding Help
...
If there is information from the codebase, documentation, IDE, or other tools that you want to include as context, you can type @ to select and include it as context. You can learn more about how to use this in [Chat context selection](/ide-extensions/chat/quick-start).
...
## Change AI Models in Qivryn Chat for Different Coding Needs
