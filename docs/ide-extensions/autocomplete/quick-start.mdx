---
title: "Quick Start with Qivryn Autocomplete"
description: "Learn how to quickly start using Qivryn's AI autocomplete in your IDE, including enabling inline code suggestions and keyboard shortcuts for accepting, rejecting, or partially accepting completions."
sidebarTitle: "Autocomplete Quick Start"
---

## How to Enable and Use Qivryn Autocomplete

Autocomplete provides inline code suggestions as you type. To enable it, simply click the "Qivryn" button in the status bar at the bottom right of your IDE or ensure the "Enable Tab Autocomplete" option is checked in your IDE settings.
