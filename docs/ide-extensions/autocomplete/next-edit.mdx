---
title: "Next Edit"
description: "Learn how Qivryn's Next Edit feature predicts and suggests your next code changes using AI, going beyond traditional autocomplete to anticipate entire code modifications"
---

<Warning>
  Next Edit is currently an experimental feature. It requires
  [Instinct](https://qivryn.ai/qivryn/instinct) or [Mercury Coder
  model](https://qivryn.ai/inception/mercury-coder) configured in
  your Qivryn autocomplete settings and is not yet available for JetBrains
  use.
</Warning>
...
<Note>
  ...
  in your Qivryn autocomplete model settings. This model is specifically
...
- **Instinct**: The leading open Next Edit model, trained by Qivryn

### Automatic Detection

Qivryn automatically enables Next Edit when:
...
<Card title="Provide Feedback" icon="message">
  Have feedback? We want to hear it. __[File an issue on GitHub](https://github.com/atnumridha/qivryn/issues)__
  to help us improve.
</Card>

  <Card title="Combine with Other Features" icon="puzzle-piece">
    Use Next Edit alongside Qivryn's Chat and Agent modes for comprehensive AI-assisted development.
  </Card>
</CardGroup>

---

_Next Edit represents Qivryn's vision for proactive AI coding assistance that anticipates developer needs rather than just reacting to input. As this feature evolves, it will become a powerful tool for accelerating development workflows and reducing repetitive coding tasks._
