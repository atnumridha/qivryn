---
title: "Recommended Models for Autocomplete in Qivryn"
description: "Choose the best autocomplete model for Qivryn, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models."
...
For proactive code prediction that anticipates your next edit, Qivryn supports specialized [Next Edit](/ide-extensions/autocomplete/next-edit) models:
