...
description: "Learn Qivryn's core features through hands-on exercises. Get started with Autocomplete, Edit, Chat, and Agent mode in minutes."
sidebarTitle: "Quick Start"
---

Welcome to Qivryn! This interactive tutorial will guide you through all four core features using practical examples. Follow along step-by-step to learn more about Qivryn's capabilities.

<Info>
  **Prerequisites**: Make sure you have [installed
  Qivryn](/ide-extensions/install) and [signed
  in](https://auth.qivryn.ai/) to get started.
</Info>
...
Press **Enter** and watch Qivryn suggest code completions. Press **Tab** to accept suggestions.

</Step>

<Step title="See the Magic">
Qivryn will intelligently suggest function implementations based on the context and comment.
</Step>
</Steps>
...
<Step title="Watch the Magic">
  Watch Qivryn refactor your code automatically!
</Step>

<Step title="Review Changes">
Qivryn will show you a diff of the proposed changes. Accept or reject individual changes as needed.
</Step>
</Steps>
...
Ready to explore more? Qivryn offers five powerful features to enhance your coding workflow:
<Tabs>
...
Congratulations! You've experienced all four core Qivryn features. Here's what to explore next:
