---
title: "Recommended Models for Chat in Qivryn"
description: "Choose the best chat model for Qivryn, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models."
