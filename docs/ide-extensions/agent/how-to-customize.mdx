...
description: "Learn how to customize Agent Mode in Qivryn to better fit your workflow and coding style."
...
- **Ask First (default)**: Request user permission with "Cancel" and "Qivryn" buttons
