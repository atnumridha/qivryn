---
title: "Plan Mode in Qivryn – Safe, Read-Only Code Exploration"
sidebarTitle: "Plan Mode"
description: "Learn how to use Plan Mode in Qivryn to explore and understand codebases safely with read-only tools, search, and analysis before making changes"
---
