...
1. Qivryn sends a special system message instructing the model to focus on understanding and planning
...
<Info>
  ...
  are not filtered by Qivryn. Some MCP tools may have write capabilities that
...
<Info>
  ...
  the
  code](https://github.com/atnumridha/qivryn/blob/main/core/llm/defaultSystemMessages.ts).
</Info>
