...
| Saved layouts | Qivryn provides Agent, Editor, Zen, Browser, and maximized-chat presets plus workspace-saved aliases.          | Saved layouts currently reference a built-in arrangement rather than capturing arbitrary editor geometry. |
