...
const vscodeShortcuts: Omit<KeyboardShortcutProps, "isEven">[] = [
  ...
  },
  {
    shortcut: "cmd L",
    description:
      "New Chat / New Chat With Selected Code / Close Qivryn Sidebar If Chat Already In Focus",
  },
  {
  ...
  },
  {
    ...
    description:
      "Focus Current Chat / Add Selected Code To Current Chat / Close Qivryn Sidebar If Chat Already In Focus",
  },
  {
        ...
        <div>
          ...
          <Card className="!p-0">
            <div className="flex flex-col">
              <ConfigRow
                title="Documentation"
                description="Learn how to configure and use Qivryn"
                icon={LinkIcon}
                onClick={() =>
                  ideMessenger.post("openUrl", "https://docs.qivryn.ai/")
                }
              />
            </div>
          </Card>
