# Contributing to Qivryn

## Table of Contents

- [Contributing to Qivryn](#contributing-to-qivryn)
  - [Table of Contents](#table-of-contents)
- [❤️ Ways to Contribute](#️-ways-to-contribute)
  - [👋 Qivryn Contribution Ideas](#-qivryn-contribution-ideas)
  ...
  - [🧑‍💻 Contributing Code](#-contributing-code)
    - [Environment Setup](#environment-setup)
      ...
      - [Fork the Qivryn Repository](#fork-the-qivryn-repository)
      - [VS Code](#vs-code)
        - [Debugging](#debugging)
      - [JetBrains](#jetbrains)
  ...
  - [📐 Qivryn Architecture](#-qivryn-architecture)
    - [Qivryn VS Code Extension](#qivryn-vs-code-extension)
    - [Qivryn JetBrains Extension](#qivryn-jetbrains-extension)
  - [Contributor License Agreement](#contributor-license-agreement-cla)

# ❤️ Ways to Contribute

## 👋 Qivryn Contribution Ideas

[This GitHub project board](https://github.com/orgs/qivryn/projects/2) is a list of ideas for how you can
contribute to Qivryn. These aren't the only ways, but are a great starting point if you are new to the project. You
can also browse the list
of [good first issues](https://github.com/atnumridha/qivryn/issues?q=is:issue%20state:open%20label:good-first-issue).

## 🐛 Report Bugs

If you find a bug, please [create an issue](https://github.com/atnumridha/qivryn/issues) to report it! A great bug
report includes:
...
Qivryn is quickly adding features, and we'd love to hear which are the most important to you. The best ways to suggest
an enhancement are:

- Create an issue

  - First, check whether a similar proposal has already been made
  - If not, [create an issue](https://github.com/atnumridha/qivryn/issues)
  - Please describe the enhancement in as much detail as you can, and why it would be useful

- Join the [GitHub Discussions](https://github.com/atnumridha/qivryn/discussions) and tell us about your idea

## 📖 Updating / Improving Documentation

Qivryn is continuously improving, but a feature isn't complete until it is reflected in the documentation! If you see
something out-of-date or missing, you can help by clicking "Edit this page" at the bottom of any page
on [docs.qivryn.ai](https://docs.qivryn.ai).
...
#### Fork the Qivryn Repository

1. Go to the [Qivryn GitHub repository](https://github.com/atnumridha/qivryn) and fork it to your GitHub account.

2. Clone your forked repository to your local machine. Use: `git clone https://github.com/YOUR_USERNAME/qivryn.git`
...
3. To package the extension, run `npm run package` in the `extensions/vscode` directory, select `Tasks: Run Task` and
   then select `vscode-extension:package`. This will generate `extensions/vscode/build/qivryn-{VERSION}.vsix`, which
...
To keep the Qivryn codebase clean and maintainable, we expect the following from our own team and all contributors:
...
- **For new features**: Include a short screen recording or screenshot demonstrating the new functionality. This makes it much easier for us as contributors to review and understand your changes. See [this PR](https://github.com/atnumridha/qivryn/pull/6455) as a good example
- Open a PR against the `main` branch. Make sure to fill in the PR template

### Formatting

Qivryn uses [Prettier](https://marketplace.visualstudio.com/items?itemName=esbenp.prettier-vscode) to format
JavaScript/TypeScript. Please install the Prettier extension in VS Code and enable "Format on Save" in your settings.

### Theme Colors

Qivryn has a set of named theme colors that we map to extension colors and tailwind classes, which can be found in [gui/src/styles/theme.ts](gui/src/styles/theme.ts)
...
Join the [GitHub Discussions](https://github.com/atnumridha/qivryn/discussions) to engage with maintainers and other contributors.

## Contributing New LLM Providers/Models

### Adding an LLM Provider

Qivryn has support for more than a dozen different LLM "providers", making it easy to use models running on OpenAI,
Ollama, Together, LM Studio, Msty, and more. You can find all of the existing
providers [here](https://github.com/atnumridha/qivryn/tree/main/core/llm/llms), and if you see one missing, you can
...
While any model that works with a supported provider can be used with Qivryn, we keep a list of recommended models
...
- LLM Providers: Since many providers use their own custom strings to identify models, you'll have to add the
  translation from Qivryn's model name (the one you added to `index.d.ts`) and the model string for each of these
...
- [Prompt Templates](./core/llm/autodetect.ts) - In this file you'll find the `autodetectTemplateType` function. Make
  ...
  the chat template for that model is already built in Qivryn. If not, you will have to add the template type and
