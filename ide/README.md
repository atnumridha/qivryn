...
The command clones the pinned Code - OSS source into `ide/.build/vscode`, applies the Qivryn product configuration and icons, packages the Qivryn extension, and stages both Qivryn extensions as in-box extensions.
