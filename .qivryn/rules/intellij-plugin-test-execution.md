...
```bash
./gradlew test --tests "com.github.qivryn.qivrynintellijextension.unit.ApplyToFileHandlerTest"
```

## Run specific test method

```bash
./gradlew test --tests "com.github.qivryn.qivrynintellijextension.unit.ApplyToFileHandlerTest.should*"
```
