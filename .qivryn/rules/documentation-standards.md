...
description: This style guide should be used as a reference for maintaining consistency across all Qivryn documentation
alwaysApply: false
---

# Qivryn Documentation Style Guide
...
- **Product Names**: Capitalize product names correctly (VS Code, JetBrains, Qivryn)
- **Feature Names**: Use consistent capitalization for Qivryn features (Chat, Edit, Agent, Autocomplete)
...
- Avoid "we" unless referring to the Qivryn team
