...
If your message is between webview and core, add it to `extensions/intellij/src/main/kotlin/com/github/qivryn/qivrynintellijextension/constants/MessageTypes.kt`.
